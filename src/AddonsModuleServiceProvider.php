...
class AddonsModuleServiceProvider extends AddonServiceProvider
{
    ...
    protected $routes = [
        ...
        'admin/addons/extensions/readme/{extension}'       => 'Anomaly\AddonsModule\Http\Controller\Admin\ExtensionsController@readme',
        'admin/addons/field_types'                         => 'Anomaly\AddonsModule\Http\Controller\Admin\FieldTypesController@index',
        'admin/addons/field_types/readme/{fieldType}'      => 'Anomaly\AddonsModule\Http\Controller\Admin\FieldTypesController@readme',
        ...
        'admin/addons/modules/install/{module}'            => 'Anomaly\AddonsModule\Http\Controller\Admin\ModulesController@install',
        'admin/addons/modules/uninstall/{module}'          => 'Anomaly\AddonsModule\Http\Controller\Admin\ModulesController@uninstall',
        'admin/addons/modules/readme/{module}'             => 'Anomaly\AddonsModule\Http\Controller\Admin\ModulesController@readme',
        'admin/addons/plugins'                             => 'Anomaly\AddonsModule\Http\Controller\Admin\PluginsController@index',
        'admin/addons/plugins/readme/{plugin}'             => 'Anomaly\AddonsModule\Http\Controller\Admin\PluginsController@readme',
        'admin/addons/themes'                              => 'Anomaly\AddonsModule\Http\Controller\Admin\ThemesController@index',
        'admin/addons/themes/readme/{theme}'               => 'Anomaly\AddonsModule\Http\Controller\Admin\ThemesController@readme',
    ];
